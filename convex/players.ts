...
export const get = query({
  ...
  handler: async (ctx, args) => {
    return await ctx.db.get("players", args.playerId)
  },
})
...
export const updateCash = internalMutation({
  ...
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch("players", args.playerId, { cash: newCash })
...
export const setCash = internalMutation({
  ...
  handler: async (ctx, args) => {
    await ctx.db.patch("players", args.playerId, { cash: args.cash })
  },
})
...
export const updatePosition = internalMutation({
  ...
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch("players", args.playerId, { position: normalizedPosition })
  },
})
