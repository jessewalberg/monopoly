...
export interface DecisionContext {
  ...
  otherPlayers: Array<PlayerContext>
  allProperties: Array<PropertyContext>
  turnNumber: number
  gamePhase: GamePhase
}
