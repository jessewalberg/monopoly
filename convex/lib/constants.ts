...
export const BOARD: ReadonlyArray<BoardSpace> = [
...
export const CHANCE_CARDS: ReadonlyArray<ChanceCard> = [
  {
    id: 1,
  ...
  {
    id: 4,
    text: 'Advance to the nearest Utility. If unowned, you may buy it. If owned, throw dice and pay owner 10× the amount thrown.',
  ...
  {
    id: 10,
    text: 'Make general repairs on all your property: Pay $25 for each house and $100 for each hotel.',
...
export const COMMUNITY_CHEST_CARDS: ReadonlyArray<CommunityChestCard> = [
  {
    id: 1,
    text: 'Advance to GO. Collect $200.',
    action: 'move_to',
