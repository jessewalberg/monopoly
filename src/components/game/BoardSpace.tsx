...
function PropertySpaceContent({
  ...
  return (
    <div className={`w-full h-full bg-[#D5E8D4] relative overflow-hidden ${isMortgaged ? "opacity-50" : ""}`}>
    ...
    <div className={`w-full h-full bg-[#D5E8D4] relative overflow-hidden ${isMortgaged ? "opacity-50" : ""}`}>
      <div className="absolute inset-0 flex items-center justify-center overflow-hidden">
        <div
          className={`flex flex-col items-center justify-center gap-0 origin-center ${rotationClass}`}
        >
          <svg className="w-3 h-3 sm:w-4 sm:h-4 text-black flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <div className={`w-full h-full bg-[#D5E8D4] relative overflow-hidden ${isMortgaged ? "opacity-50" : ""}`}>
      <div className="absolute inset-0 flex items-center justify-center overflow-hidden">
        ...
        >
          {isElectric ? (
            <svg className="w-3 h-3 sm:w-4 sm:h-4 text-yellow-500 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
              <path d="M13 2L4 14h7l-1 8 9-12h-7l1-8z" />
            </svg>
          ) : (
            <svg className="w-3 h-3 sm:w-4 sm:h-4 text-blue-500 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
...
function GoSpace({ players, currentPlayerId }: { players: PlayerOnBoard[]; currentPlayerId?: Id<"players"> }) {
  return (
    <div className="w-full h-full bg-[#D5E8D4] flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <span className="text-[6px] sm:text-[7px] text-red-600 font-bold">COLLECT</span>
      <span className="text-[6px] sm:text-[7px] text-red-600 font-bold">$200</span>
      <span className="text-base sm:text-lg font-black text-red-600 -rotate-45 mt-0.5">GO</span>
  ...
  return (
    <div className="w-full h-full bg-[#D5E8D4] flex flex-col items-center justify-between p-0.5 relative overflow-hidden">
      ...
      <div className="absolute right-0 top-0 w-[70%] h-[70%] bg-orange-400 border border-black flex items-center justify-center overflow-hidden">
        ...
        <span className="text-[5px] sm:text-[6px] font-bold text-black z-10 bg-orange-400 px-0.5">JAIL</span>
...
function FreeParkingSpace({ players, currentPlayerId }: { players: PlayerOnBoard[]; currentPlayerId?: Id<"players"> }) {
  return (
    <div className="w-full h-full bg-[#D5E8D4] flex flex-col items-center justify-center relative overflow-hidden">
      <span className="text-[6px] sm:text-[7px] font-bold text-black drop-shadow-sm">FREE</span>
      <svg className="w-5 h-5 sm:w-6 sm:h-6 text-red-600" viewBox="0 0 24 24" fill="currentColor">
        <path d="M13 3H6v18h4v-6h3c3.31 0 6-2.69 6-6s-2.69-6-6-6zm.2 8H10V7h3.2c1.1 0 2 .9 2 2s-.9 2-2 2z" />
      </svg>
      <span className="text-[5px] sm:text-[6px] font-bold text-black drop-shadow-sm">PARKING</span>
      <PlayerTokensOverlay players={players} currentPlayerId={currentPlayerId} />
    </div>
  );
}
...
function GoToJailSpace({ players, currentPlayerId }: { players: PlayerOnBoard[]; currentPlayerId?: Id<"players"> }) {
  return (
    <div className="w-full h-full bg-[#D5E8D4] flex flex-col items-center justify-center relative overflow-hidden">
      <span className="text-[5px] sm:text-[6px] font-bold text-black drop-shadow-sm">GO TO</span>
      ...
      <span className="text-[6px] sm:text-[7px] font-bold text-black drop-shadow-sm">JAIL</span>
      <PlayerTokensOverlay players={players} currentPlayerId={currentPlayerId} />
    </div>
  );
}
  ...
  return (
    <div className="w-full h-full bg-[#D5E8D4] flex items-center justify-center relative overflow-hidden">
      <div className={`flex items-center gap-0.5 origin-center ${rotationClass} ${contentOffsetClass}`}>
        <span className="text-[5px] sm:text-[6px] font-bold text-orange-600 drop-shadow-sm">CHANCE</span>
  ...
  return (
    <div className="w-full h-full bg-[#D5E8D4] flex items-center justify-center relative overflow-hidden">
      <div className={`flex items-center gap-0.5 origin-center ${rotationClass} ${contentOffsetClass}`}>
        ...
        <span className="text-[4px] sm:text-[5px] font-bold text-blue-600 drop-shadow-sm">CHEST</span>
      </div>
      <PlayerTokensOverlay players={players} currentPlayerId={currentPlayerId} side={side} />
    </div>
  );
...
function TaxSpace({ space, side, players, currentPlayerId }: { space: BoardSpace & { type: "tax"; amount: number }; side: BoardSide; players: PlayerOnBoard[]; currentPlayerId?: Id<"players"> }) {
  ...
  return (
    <div className="w-full h-full bg-[#D5E8D4] flex items-center justify-center relative overflow-hidden">
      <div className={`flex flex-col items-center gap-0 origin-center ${rotationClass} ${contentOffsetClass}`}>
        ...
        <span className="text-[5px] sm:text-[6px] font-bold text-black drop-shadow-sm">${space.amount}</span>
      </div>
      <PlayerTokensOverlay players={players} currentPlayerId={currentPlayerId} side={side} />
    </div>
  );
